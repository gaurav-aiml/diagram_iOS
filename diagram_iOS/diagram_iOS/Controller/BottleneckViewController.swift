...
//                self.menuView.setNeedsDisplay()
//                self.basicBarChart.setNeedsLayout()
//                self.basicBarChart.setNeedsDisplay()
            }
            else{
...
//                self.basicBarChart.setNeedsDisplay()
        ...
        print(self.menuView.isHidden, self.basicBarChart.isHidden)
...
//            self.view.setNeedsDisplay()
    ...
    func configureBarChart(){
        titleLabel = UILabel(frame: CGRect(x: 0, y: 100, width: self.view.frame.width, height: 70))
        ...
        basicBarChart = BasicBarChart(frame: CGRect(x: 0, y: 200, width: self.view.frame.width, height: 200))
